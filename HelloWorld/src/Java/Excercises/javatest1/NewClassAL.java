...
class  NewClassAL
{
	...
	{
		Integer numStudents = Integer.valueOf(args[0]);
		...
		// 2. creates a course that can hold five students
		    CourseAL javaProgrammingCourse = new CourseAL("Java Programming", numStudents-1); 
		// 3. Print the course
		...
		// 13. Additional Check  - Try adding a student that exists in the roster already
			System.out.println("Trying to add a duplicate record ....: \n");
			javaProgrammingCourse.addStudent(newStudents[0]);
		// Print  the roster
			System.out.println("List after failing the attempt to add dulicate record for Andrew  again into the roster"); 
			javaProgrammingCourse.printRoster();

		
		
		// 10. Try again to add the sixth student to the course as it has space now
		...
		// 11. Print the roster
			...
			javaProgrammingCourse.printRoster();
		// 12. Additional Check  - Try again to add the another student to the course when the roster is full
		...
		// Print  the roster
			System.out.println("List after failing the attempt to add another student with name YetAnotherExtra again into the roster"); 
			javaProgrammingCourse.printRoster();



		
		// 14. Additional Check  - Try to Drop a non-existing student from the course
		...
		//  Note: Alternatively we can use arraylist.clear() method instead of deleting each individual element
		...
		System.out.println("------------------------ *** Abitha Thuru *** ----------------------"); 
		System.out.println("--------------------------------------------------------------------"); 
